...
void Update(float delta_time) {
  ...
  for (auto it1 = rigidbody_components.begin();
    ...
    vec2 transformed_physics_aabb_top_left1 =
        rigidbody1.collision_aabb.top_left + transform1.position;
    vec2 transformed_physics_aabb_bottom_right1 =
        rigidbody1.collision_aabb.bottom_right + transform1.position;
    ...
    for (auto it2 = std::next(it1); it2 != rigidbody_components.end(); ++it2) {
      ...
      vec2 transformed_physics_aabb_top_left2 =
          rigidbody2.collision_aabb.top_left + transform2.position;
      vec2 transformed_physics_aabb_bottom_right2 =
          rigidbody2.collision_aabb.bottom_right + transform2.position;
    ...
    for (auto &[entity2, staticbody2] : staticbody_components) {
      ...
      vec2 transformed_physics_aabb_top_left2 =
          staticbody2.aabb_top_left + transform2.position;
      vec2 transformed_physics_aabb_bottom_right2 =
          staticbody2.aabb_bottom_right + transform2.position;
